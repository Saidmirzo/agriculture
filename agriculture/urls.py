...
from .views import DeviceDataView, DeviceStatusView, SendEventView, TriggerEventView, UpdateLocationView, UploadImageView, UploadLogsView,BotUserView, device_logs_view, real_device_logs_view
